...
const musicList = [
  {url: "monstercat/crankdat-tynan-vexed", highLight: 44},
  {url: "monstercat/crankdat-b-t-w-whistle", highLight: 67},
  {url: "monstercat/pegboardnerds-blackout", highLight: 36},
  {url: "itsmiyuridesu/exodie-hookington-magic-wand-miyuri-remix-1", highLight: 39},
  {url: "deturaofficial/must-die-animal-parade-detura-remix", highLight: 50},
  {url: "https://soundcloud.com/deturaofficial/break-free", highLight: 46},
  {url: "https://soundcloud.com/musical-freedom/tiesto-x-swacq-party-time", highLight: 15},
  {url: "https://soundcloud.com/figure/gravity", highLight: 44},
  {url: "golddiggerrecs/vibe-out-in-your-face-original-mix-1", highLight: 29},
  {url: "hirshee/calvertron-qalvr-raw-2-da", highLight: 35},
  {url: "blacktigersexmachine/face-down", highLight: 49},
  {url: "swoondubstep/must-speed-speed-shards", highLight: 42},
...
function randomMusic(){
  ...
  highLight = musicList[index].highLight;
  widget.load(`https://soundcloud.com/${url}`, {download:false, show_artwork:false, buying:false, sharing:false, single_active:true, auto_play:true});
}

document.addEventListener("DOMContentLoaded", function() {
  var musicChangeButton = document.getElementById("musicChangeButton");

  musicChangeButton.addEventListener("click", function() {
    randomMusic();
  });
});
...
widget.bind(SC.Widget.Events.PLAY, function() {
  if(highLightStart){
    widget.seekTo(highLight * 1000);
    highLightStart = false;
    widget.setVolume(musicSound);
  }
});
